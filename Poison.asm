...
jsl $c37a30     ; Calculate Poison tick damage and set timer
nop #21
...
jsr $66af       ; Jump to calculate timer reference based on Battle Speed
nop #5

org $fd66af     ; Free Space
php             ; Push flags
phy             ; Push Y
phx             ; Push X
...
adc #$28        ; Add Stamina/5.82 + 41
sta $00         ; Store the base interval
stz $29
lsr
sta $28         ; Store Interval / 2
stz $2b
